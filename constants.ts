...
export const SAMPLE_PRODUCTS: Product[] = [
  ...
  { id: 'lc-021', sku: 'LC0021', name: 'Colar Chocker de Pérolas', price: 0, stock: 0, category: 'Colares', imageUrl: createImageUrlBase('Colar Chocker de Pérolas') },
  ...
  { id: 'lc-030', sku: 'LC0030', name: 'Brinco Prateado Gota', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Prateado Gota') },
  { id: 'lc-031', sku: 'LC0031', name: 'Brinco Dourado de Trevo com Zircônia Verde', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Dourado de Trevo com Zircônia Verde') },
  { id: 'lc-032', sku: 'LC0032', name: 'Brinco Dourado Gota', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Dourado Gota') },
  ...
  { id: 'lc-035', sku: 'LC0035', name: 'Brinco com 4 Pontos de Luz em Zircônia', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco com 4 Pontos de Luz em Zircônia') },
  { id: 'lc-036', sku: 'LC0036', name: 'Brinco Ponto de Luz em Zircônia', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Ponto de Luz em Zircônia') },
  { id: 'lc-037', sku: 'LC0037', name: 'Brinco Ponto de Luz Pequeno em Zircônia', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Ponto de Luz Pequeno em Zircônia') },
  { id: 'lc-038', sku: 'LC0038', name: 'Brinco de Argolinha com Pedra de Zircônia em Formato de Estrela', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco de Argolinha com Pedra de Zircônia em Formato de Estrela') },
  { id: 'lc-039', sku: 'LC0039', name: 'Pulseira Dourada Trevos Com Zircônias Preta', price: 0, stock: 0, category: 'Pulseiras', imageUrl: createImageUrlBase('Pulseira Dourada Trevos Com Zircônias Preta') },
  { id: 'lc-040', sku: 'LC0040', name: 'Brinco de Gota em Zircônia', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco de Gota em Zircônia') },
  ...
  { id: 'lc-042', sku: 'LC0042', name: 'Colar Medalha Olho Grego', price: 0, stock: 0, category: 'Colares', imageUrl: createImageUrlBase('Colar Medalha Olho Grego') },
  { id: 'lc-043', sku: 'LC0043', name: 'Brinco de Pedra Zircônia em formato de Coração', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco de Pedra Zircônia em formato de Coração') },
  { id: 'lc-044', sku: 'LC0044', name: 'Brinco Clássico de Pérola', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Clássico de Pérola') },
  { id: 'lc-045', sku: 'LC0045', name: 'Pulseira de Pérolas e Bolinhas', price: 0, stock: 0, category: 'Pulseiras', imageUrl: createImageUrlBase('Pulseira de Pérolas e Bolinhas') },
  { id: 'lc-046', sku: 'LC0046', name: 'Pulseira Trançada', price: 0, stock: 0, category: 'Pulseiras', imageUrl: createImageUrlBase('Pulseira Trançada') },
  { id: 'lc-047', sku: 'LC0047', name: 'Corrente Delicada Trançada', price: 0, stock: 0, category: 'Colares', imageUrl: createImageUrlBase('Corrente Delicada Trançada') },
  { id: 'lc-048', sku: 'LC0048', name: 'Brinco Ear Cuff Cristal Gota', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Ear Cuff Cristal Gota') },
  { id: 'lc-049', sku: 'LC0049', name: 'Brinco de Argolinha Pequeno Coração', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco de Argolinha Pequeno Coração') },
  { id: 'lc-050', sku: 'LC0050', name: 'Brinco de Coração Rosa', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco de Coração Rosa') },
  { id: 'lc-051', sku: 'LC0051', name: 'Escapulário São Jorge', price: 0, stock: 0, category: 'Colares', imageUrl: createImageUrlBase('Escapulário São Jorge') },
  { id: 'lc-052', sku: 'LC0052', name: 'Escapulário Quadrado', price: 0, stock: 0, category: 'Colares', imageUrl: createImageUrlBase('Escapulário Quadrado') },
  { id: 'lc-053', sku: 'LC0053', name: 'Pulseira Elo 3 por 1', price: 0, stock: 0, category: 'Pulseiras', imageUrl: createImageUrlBase('Pulseira Elo 3 por 1') },
  { id: 'lc-054', sku: 'LC0054', name: 'Pulseira de Seta', price: 0, stock: 0, category: 'Pulseiras', imageUrl: createImageUrlBase('Pulseira de Seta') },
  { id: 'lc-055', sku: 'LC0055', name: 'Brinco Argolinha Pedra de Coração Rosa', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Argolinha Pedra de Coração Rosa') },
  { id: 'lc-056', sku: 'LC0056', name: 'Brinco Argolinha Pedra de Coração Verde', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco Argolinha Pedra de Coração Verde') },
  { id: 'lc-057', sku: 'LC0057', name: 'Brinco de Pedra Retangular Rosa', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco de Pedra Retangular Rosa') },
  { id: 'lc-058', sku: 'LC0058', name: 'Brinco de Pedra Retangular Verde', price: 0, stock: 0, category: 'Brincos', imageUrl: createImageUrlBase('Brinco de Pedra Retangular Verde') },
