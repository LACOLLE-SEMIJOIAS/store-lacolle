  ...
  return (
    <div className={`group flex flex-col h-full bg-white transition-all duration-300 ${
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-gray-50">
        ...
        {!isEditMode && product.stock > 0 && (
          <div className="absolute inset-x-0 bottom-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
            <button 
              onClick={onAddToCart}
              className="w-full bg-black/80 hover:bg-black text-white text-[9px] font-bold py-3 uppercase tracking-widest backdrop-blur-md"
            >
      ...
      <div className="py-4 flex flex-col gap-1">
        <h3 className="text-[10px] font-medium text-zinc-400 uppercase tracking-widest truncate">
          {product.category}
        </h3>
